# labs-OO-Agents Archify Architecture
...
- Repository URL: https://github.com/hundong2/labs-OO-Agents.git
- Checkout SHA: 38d5bee234afe6099e65335d1327e769c40f66b4
- README file: README_kor.md
- Evidence file: README_kor.md
- README title:
- Dependency markers: Python, uv
- Top-level directories: assets, docs, examples, guide, packages, scripts, skills
- Category: Agents and platforms

## 적용 프롬프트

~~~~text
Use Archify to create a high-level architecture diagram for labs-OO-Agents.
